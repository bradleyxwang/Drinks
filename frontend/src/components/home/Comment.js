...
const RecentCommentReview = ({ profile, review }) => {
  ...
  useEffect(() => {
    setCardInfo({
      ...
      body: <div><Comment comment={review.comment} /></div>,
      footer: `${renderDateStr(detailedReview.date)}`,
    });
  }, [detailedReview]);
...
export default RecentCommentReview;
